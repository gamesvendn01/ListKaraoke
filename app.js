...
// ─── Config ───────────────────────────────────────────────────────────────────
// songs.json và index.html đều ở ROOT repo → dùng ./songs.json
// GitHub Pages: https://user.github.io/ListKaraoke/ → ./songs.json ✅
// Local preview: file:///path/web/index.html → ../songs.json (nếu dùng local phải mở từ root)
